...
export default function OpeningScreen() {
   ...
   */
  let wrapperDummy = document.getElementsByClassName(
    "Wrapper"
  ) as HTMLCollectionOf<HTMLElement>;
  let openingScreenDummy = document.getElementsByClassName(
    "OpeningScreen"
  ) as HTMLCollectionOf<HTMLElement>;
   ...
   */
  useEffect(() => {
    let wrapperArray = document.getElementsByClassName(
      "Wrapper"
    ) as HTMLCollectionOf<HTMLElement>;
    let openingScreenArray = document.getElementsByClassName(
      "OpeningScreen"
    ) as HTMLCollectionOf<HTMLElement>;
  ...
  return (
    <div className="OpeningScreen" onClick={() => handleClick()}>
      <div className="OpeningScreenInnerContainer">
